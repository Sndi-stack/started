...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix mb-2">
         <div class="pull-left">
            <h2 class="text-primary"><i class="icon-copy dw dw-edit-1"></i> Edit Data Pembayaran</h2>
         </div>
      ...
      <form action="/admin/pembayaran/update/{{ $pembayaran->id }}" method="POST">
         ...
         <div class="form-group">
            ...
            <input type="text" name="nama" required class="form-control" value="{{ $pembayaran->nama }}">
         </div>
         <button type="submit" class="btn btn-primary"><i class="ti-save"></i> Update Data</button>
      </form>
   </div>
</div>
@endsection
